...
export const fetchSubCategory = (id) => async (dispatch) => {
    await API_getSubCategory(id).then(res => {
        dispatch({
...
export const fetchAllSubCategories = () => async (dispatch) => {
    await API_getSubCategories().then(res => {
        dispatch({
...
export const createSubCategory = (data) => async (dispatch) => {
    await API_createSubCategory(data).then(res => {
        dispatch({
...
export const updateSubCategory = (id, data) => async (dispatch) => {
    await API_updateSubCategory(id, data).then(res => {
        dispatch({
...
export const deleteSubCategory = (id) => async (dispatch) => {
    await API_deleteSubCategory(id).then(res => {
        dispatch({
